---
title: 'I built a better workflow for React Native Skia shaders and accidentally hit #1 on r/reactnative with 12K views'
...
Recently, I shared a tool I built to solve my own workflow problems on `r/reactnative`. Within 24 hours, it blew up. It became the **#1 post on r/reactnative that day** and racked up over **12,000 views**, a flood of upvotes, and incredible engagement.
...
When I shared this on Reddit, I focused on the problem rather than just dropping a link. Developers have a high appreciation for technical problem-solving. Here is the post I made on `r/reactnative` that resonated so well:
...
The response was overwhelming because it named a universal pain point and offered a technical architecture shift to solve it. Almost every RN dev has dealt with Lottie performance issues and dropped frames.
